...
const NuevoPassword = () => {
  return (
    ...
    <form action="" className="my-10 bg-white shadow rounded-lg p-10">
      ...
      <input type="submit" value="Guardar nuevo password" className="bg-sky-700 mb-5 py-3 w-full text-white uppercase font-bold rouned hover:cursor-pointer hover:bg-sky-800 transition-colors" />
    </form>
    </>
  )
}
